...
/*****************************************************************************
**
**  Definition of the boxing C interface
**
...
int                boxing_format_get_stripe_size(struct boxing_config_s * format);
int                boxing_format_is_data_striped(struct boxing_config_s * format);
