...
static struct boxing_tracker_s *   frame_gpf_1_create_frame_tracker(boxing_frame * frame);
                    ...
                    int analog_content_symbol_size, int digital_content_symbol_size, int reference_bar_sync_distance, int reference_bar_sync_offset)
{
    ...
    frame->base.create_frame_tracker = frame_gpf_1_create_frame_tracker;
...
static struct boxing_tracker_s * frame_gpf_1_create_frame_tracker(boxing_frame * frame) // move me!
{
    return (struct boxing_tracker_s *)boxing_frame_tracker_gpf_1_create(((boxing_frame_gpf_1*)frame));
}
