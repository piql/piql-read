...
//----------------------------------------------------------------------------
/*!
 *  \defgroup   metadata  Frame metadata.
 *  \ingroup    unbox
 *
 *  Structures and functions to read metadata read from the metadata band
 ...
 *  \param deserialize  Function to deserialize data.
 *  \param free         Function to free the occupied memory.
 *
...
//----------------------------------------------------------------------------
/*!
 *  \brief Determines whether there is an item of given type in the list
 *
 *  Function determines whether there is an item in the list of the specified type.
 *  Returns zero if the items of specified type not in the list.
 *
 *  \ingroup metadata
 *  \param[in]  list  The pointer to meta data list instance.
 *  \param[in]  type  The type of meta data item.
 *  \return signs of having the specified type of an item.
 */
